    ...
    <!-- jQuery -->
    <script src="<?= base_url('assets/'); ?>pluginsadmin/jquery/jquery.min.js"></script>
    
    <!-- Bootstrap -->
    <script src="<?= base_url('assets/'); ?>pluginsadmin/bootstrap/js/bootstrap.bundle.min.js"></script>

    <!-- jQuery UI -->
    <script src="<?= base_url('assets/'); ?>pluginsadmin/jquery-ui/jquery-ui.min.js"></script>
